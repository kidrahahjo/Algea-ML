...
def f(a1,a2,a3,a4,a5,n):
    ...
    for i in range(0,n):
        ...
        x4=a4[i]
        x5=a5[i]
        z = sqrt(2)*sqrt(x1)*sin(x2)/4 + 3.23570226039552*sqrt(x1) + 0.3*sqrt(x1)/square(3) + sqrt(x1)/sqrt(x2) + 0.0333333333333333*sqrt(3)*x1*sin(x2) - 1.82574185835055*x1*sin(x3) + x1/2 + 1.41421356237309*sqrt(2)*x1 - sqrt(x2)*sqrt(x3)*sin(x1) - sqrt(x2)*sin(x3)*sin(x4) + sqrt(x2)/sin(x2) + sqrt(5)*sqrt(x2)/(25*sin(x1)) + 1.09983341664683*sqrt(x2)/sin(x1) - 1.41421356237309*x2*sin(x3) - sqrt(x3)*sin(x1) + sqrt(x3) - 3.33333333333333*sqrt(x3)*sin(x3)/square(x2) + x3 + 6.66666666666667*x3/square(x2) + 0.166666666666667*sqrt(10)*x3/square(3) + 3*sqrt(x4)*sin(5) - 1.29552020666134*sqrt(x4) + x4 + square(0.1) - square(0.3) - square(2) + sqrt(5)*square(x1)/25 + sqrt(3)*square(x1)/15 + 2.95205744613958*sin(x2) - 3.4794255386042*sin(x4) + sqrt(5)*sin(5) + sin(5) + 0.316227766016838/sin(5) + sin(3) + 0.640106947813537 + sqrt(2) + 0.712039324756716/sin(x2) + sqrt(2)*sin(x2)/(2*sin(x1)) - 0.29552020666134*square(x1)/square(0.5) - 0.29552020666134/square(0.5) - 0.774945745265543/(square(0.3)*sin(x4)) + sqrt(5)*sin(x3)/(5*sqrt(x3))
