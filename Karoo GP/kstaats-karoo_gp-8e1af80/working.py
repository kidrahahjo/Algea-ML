...
Optimum Solution obtained for the following params:
    1. Features not used - Mixing Rate, Highest dataset dropped - Not so smart (Stuck in local Optima)
        ...
        Function - 3.94018205373418*sqrt(x1) + sqrt(2)*sqrt(x1)*sin(x2)/(2*x4) + 0.2*x1*sqrt(x2)/(sqrt(x3)*sin(x2)) - 1.82574185835055*x1*sin(x3) + x1/2 + 1.41421356237309*sqrt(2)*x1 - sqrt(x2)*sqrt(x3)*sin(x1) - sqrt(x2)*sin(x3)*sin(x4) + sqrt(x2)/sin(x2) - 0.14142135623731*sqrt(x2)*sin(2)*sin(x3)/sin(x1) + 1.09983341664683*sqrt(x2)/sin(x1) + x2**2*sqrt(x4)/(square(x3)*sin(x1)) - 1.41421356237309*x2*sin(x3) + 0.547722557505166*x2/x3 - sqrt(x3)*sin(x1) + sqrt(x3) - 3.33333333333333*sqrt(x3)*sin(x3)/square(x2) + x3 + 6.66666666666667*x3/square(x2) + 0.166666666666667*sqrt(10)*x3/square(3) + 3*sqrt(x4)*sin(5) - sqrt(x4) + x4 - square(0.3) + square(0.5) - square(2) + sqrt(5)*square(x1)/25 + sqrt(3)*square(x1)/15 - sin(x1) + 0.67801009884209*sin(x1)/sin(x4) + sin(x2)*sin(x4) + 2*sin(x2) - 4*sin(x4) + 2*sqrt(5)*sin(5) + 2*sin(5) + 0.316227766016838/sin(5) + 1.00660703112703 + sqrt(2) + 0.547722557505166/sin(x2) + sqrt(2)*sin(x2)/(2*sin(x1)) + 1/(5*sin(x1)) - 0.29552020666134*square(x1)/square(0.5) - 0.311505649217832/square(0.5) - 0.774945745265543/(square(0.3)*sin(x4)) + sqrt(5)/sqrt(x2) - sin(x1)/x1
...
def f(a1,a2,a3,a4,a5,n):
    ...
    for i in range(0,n):
        ...
        x4=a4[i]
        x5=a5[i]
        z = -0.29552020666134*sqrt(x1)/square(0.1) - x2 + 3.33333333333333*x2/square(x1) + 0.0998334166468282*sqrt(x3) - sqrt(x3)/sin(x2) - x3*sin(x4) + sqrt(2)*sqrt(x4)/2 + 3.4794255386042*sqrt(x4) + x4*square(0.3) - square(0.5) + square(2)/sin(x4)**2 - square(3) - 0.547722557505166*sqrt(2)*square(5) + square(x1)*sin(x4) - 10.0166861316348*sin(x1)*sin(x3)*sin(x4) + 33.3889537721159*sin(x1)*sin(x3) + sin(x1)*sin(x4) - 3.33333333333333*sin(x1) - sin(x1)/sin(x4)**2 - 10.0166861316348*sin(x2)*sin(x3) + 3*sin(x2)*sin(x4) + sin(x2) + 2.96013315568248*sin(x3) + 10.0166861316348*sin(2)*sin(x3) - 2*sin(2)*sin(x4) - 2.66378374016883 - 0.5*sin(2)*sin(3) + sin(2) + sqrt(2) - 3/(sin(2)*sin(x4)) - 3/sin(x4) - sin(2)**2/sin(x4) - 3/sin(x2) - 1.41421356237309*sin(x1)/square(x4) + 1.11111111111111*sqrt(3)*sin(3)/square(3) + 0.625748892880046*sqrt(2)*square(5)/square(0.5) - 1.41421356237309*sin(x1)/square(0.3) - 4.79425538604203/x4 + 0.239712769302102/(x4*square(3)) - 4.24264068711928/(x4*square(0.1)*square(x4)) - square(0.5)/sqrt(x4) + 2*x3/x2 - sin(x4)/sqrt(x2) + 0.29552020666134*square(0.3)/(sqrt(x2)*square(0.1)) + x2**(-3/2) + 2.0*x3/sqrt(x1)
