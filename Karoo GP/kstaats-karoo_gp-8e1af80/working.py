...
def f(a1,a2,a3,a4,a5,n):
    ...
    for i in range(0,n):
        ...
        x4=a4[i]
        x5=a5[i]
        z = -3.33333333333333*sqrt(x1) - 9.12870929175277*sqrt(x1)/(x4*square(0.3)) - sqrt(x2) + 0.316227766016838*x3 - x4*sin(x3)*sin(x4)*sin(x5) + x4 + x4*sin(x2)*sin(x5)/sin(x1) - sqrt(x5)*square(0.1)/square(x3) - sqrt(5)*sqrt(x5)*sin(x3)/2 + 2.35702260395516*sqrt(x5) - 0.911343938001598*x5 + 0.01*square(0.1)*sin(x3) + 2*square(0.1)*sin(3) + 0.316227766016838*square(0.1) + square(0.3) + 2*square(0.3)*sin(x2)/square(0.5) - 1.41421356237309*square(0.5) + square(0.5)*sin(x2)/square(2) + 5*square(5) + sqrt(3)*sin(x2)/6 + sin(x2) + sin(x3)*sin(x4) - 4.26227766016838*sin(x5) - sqrt(3) - sin(3)**2 + 0.29552020666134*sin(3) + 1.46859803359891 - 6.08580619450185*sin(5) - 0.199833416646828/square(x3) + 0.0029552020666134/(square(x3)*square(x4)) - 2*sin(x1)/square(0.5) - sin(x1)/square(0.3) - square(x1)/sqrt(x5) - 10.0*sin(x4)/(x4*square(0.3)) + square(x3)/(sqrt(x4)*x5) - 0.3/(sqrt(x3)*square(0.1)*square(5)) + sin(x2)/x1
